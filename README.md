...
* SAM CLI - [Install the SAM CLI](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/serverless-sam-cli-install.html) **[Consider using Homebrew when on Mac or Linux!!!!!]**
* Node.js - [Install Node.js 10](https://nodejs.org/en/), including the NPM package management tool.
* Docker - [Install Docker community edition](https://hub.docker.com/search/?type=edition&offering=community)

### The following command will build the source of your application:

```bash
sam build
```
 
### The following command will package and deploy your application to AWS, with a series of prompts:
```
# In First execution execute it and save to samconfig.yml
sam deploy --guided

# Next executions use just
sam deploy
```

### And this is how prompts may look like:
```
...
## Ok and what for is `template.yaml`?
This is the place where you will describe how your infrastructure will look like.
...
### Resource NOT FOUND in SAM specification??
For that you can use standard [AWS CloudFormation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html) resource types.
